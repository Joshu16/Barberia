      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-section">
            <div className="footer-logo">
              <h3>{settings?.title || 'Barbería Roxana'}</h3>
          ...
          <div className="footer-section">
            ...
            <div className="footer-contact">
              <div className="contact-item">
                ...
                <span>{settings?.address || 'Barbería Profesional'}</span>
              </div>
              {phone && (
                <div className="contact-item">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
        ...
        <div className="footer-social">
          <div className="social-links">
            ...
            {(socialMedia.whatsapp || socialMedia.whatsappBooking) && (
              <a 
                href={`https://wa.me/${(socialMedia.whatsappBooking || socialMedia.whatsapp || '').replace(/[^0-9]/g, '')}`} 
                target="_blank" 
